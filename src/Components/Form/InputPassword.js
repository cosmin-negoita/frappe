    ...
    return (
        <StyledFormField>
            ...
            <StyledDiv size={props.size}>
                {props.icon &&
                    <StyledIcon fieldSize={props.size} type="lock" color={iconColor} />
                }
                <StyledInputPassword icon={props.icon} size={props.size} name={props.name} className={props.className} isValid={props.isValid} placeholder={props.placeholder} value={props.value} onChange={props.onChange} disabled={props.disabled} />
            </StyledDiv>
